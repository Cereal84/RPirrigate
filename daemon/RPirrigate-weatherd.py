...
url = "http://api.worldweatheronline.com/free/v2/weather.ashx?q=" + str(city) + "&date=" + str(
    now_date) + "&key=dadb7eba889f53e8a61dd447cac39&format=json"
...
url = "http://api.worldweatheronline.com/free/v2/past-weather.ashx?q=" + str(city) + "&date=" + str(
    yesterday_date) + "&key=dadb7eba889f53e8a61dd447cac39&format=json"
response = urllib2.urlopen(url)
j = json.loads(response.read())
